...
SOURCE_BLEND_PATH=EXPERIMENT_OUTPUT_ROOT/'sculpted-source.blend'
...
TARGET_REST_POINTS=np.array([[0,1.03,0],[.103,.985,-.012],[-.103,.985,-.012],[0,1.125,.02],
 [.111,.56,-.015],[-.111,.56,-.015],[0,1.25,.025],[.116,.15,-.060],[-.116,.15,-.060],[0,1.54,0],
 [.116,.065,.095],[-.116,.065,.095],[0,1.555,0],[.080,1.455,-.018],[-.080,1.455,-.018],[0,1.80,0],
 [.174,1.435,-.024],[-.174,1.435,-.024],[.213,1.18,-.028],[-.213,1.18,-.028],[.289,.91,.022],[-.289,.91,.022]],dtype=float)
