...
bpy.ops.export_scene.gltf(filepath=str(EXPERIMENT_OUTPUT_ROOT/'anny-reference-fit-rig.glb'),use_selection=True,export_animations=True,export_all_influences=True)
...
bpy.ops.wm.save_as_mainfile(filepath=str(EXPERIMENT_OUTPUT_ROOT/'anny-reference-fit-rig.blend'))
