...
bpy.ops.wm.open_mainfile(filepath=str(EXPERIMENT_OUTPUT_ROOT/'anny-raw-rig.blend'))
reference_frame_arrays={}
for current_frame_number in [1]:
...
bpy.ops.import_scene.gltf(filepath=str(EXPERIMENT_OUTPUT_ROOT/'anny-raw-rig.glb'))
...
validation_result_record={'status':'passed','frame_max_errors':roundtrip_frame_errors,'tolerance':1e-4,'method':'GLB 재수입 후 기본 자세의 모든 정점과 원본 Blender 표면 정점 사이 최근접 거리'}
