...
bpy.ops.wm.open_mainfile(filepath=str(EXPERIMENT_OUTPUT_ROOT/'anny-five-head-rig.blend'))
...
for current_frame_number in [1,7,13,19,25]:
 ...
 current_mesh_object=bpy.data.objects['AnnyFiveHeadBody'].evaluated_get(bpy.context.evaluated_depsgraph_get())
...
bpy.ops.import_scene.gltf(filepath=str(EXPERIMENT_OUTPUT_ROOT/'anny-five-head-rig.glb'))
