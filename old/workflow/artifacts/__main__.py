...
from .registry import register, archive_register
...
def main():
    ...
    parser.add_argument('--archive', action='store_true', help='원본 쌍을 보관소에 복사하여 등록')
    ...
    if args.archive and args.registry is None:
        parser.error('--archive에는 --registry가 필요합니다.')
    ...
    try:
        ...
        if args.registry is not None:
            (archive_register if args.archive else register)(args.registry, args.root, args.sidecar)
