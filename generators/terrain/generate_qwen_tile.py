...
def main_generation_command():
    ...
    result_values = execute_tile_set_generation(ticket_file_path=command_arguments.ticket, style_reference_path=command_arguments.style_reference, shape_reference_path=command_arguments.shape_reference, material_reference_path=command_arguments.material_reference, trial_output_root=command_arguments.output_dir)
