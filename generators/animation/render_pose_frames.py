"""승인된 v9 MoMask 리그의 한 주기를 4방향·8프레임으로 출력한다."""
...
def execute_eight_frame_render():
    ...
    rig_render_module.OUTPUT_FRAME_COUNT = 8
    ...
    try:
        ...
        for direction_name_value,camera_point_values in rig_render_module.DIRECTION_CAMERA_POINTS.items():
            ...
            contact_sheet_image=Image.new('RGB',(512*8,512),'#202635')
            rig_reference_sheet=Image.new('RGB',(512*4,512*2),'white')
