...
def execute_pose_transfer_any_pose_batch(batch_definition_path=DEFAULT_BATCH_CONFIG, run_output_root=None):
    ...
    return execute_anypose_openpose_batch(Path(batch_definition_path).resolve(), current_output_root)
...
def run_pose_transfer_any_pose_batch_command():
    ...
    execute_pose_transfer_any_pose_batch(parsed_arguments.batch_file, parsed_arguments.output_dir)
