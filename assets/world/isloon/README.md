...
정식 맵은 `maps/iseulon.yaml`이며, 세계 확장 설정의 24×24 안전 도시 배치(청록 샘터, 꽃 화단, 길드 회관·서점·여관·대장간·시장, 서·동·남 출구)를 따른다. 최종 타일 이미지는 `slime-frontend/src/assets/world/isloon/`에 둔다.
