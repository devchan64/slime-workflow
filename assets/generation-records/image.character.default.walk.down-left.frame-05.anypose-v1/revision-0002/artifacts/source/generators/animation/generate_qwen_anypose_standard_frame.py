#!/usr/bin/env python3
"""고정 AnyPose Base/Helper 비Lightning 10스텝 파이프라인. 모델 선택 인자를 제공하지 않는다."""
import argparse
import hashlib
...
def execute_anypose_generation():
    ...
    return execute_pose_generation(trial_output_root=trial_output_root, prompt_text_value=prompt_source_text,
        ...
        pose_reference_kind='rig', selected_reference_order='standing-first', selected_inference_steps=10,
