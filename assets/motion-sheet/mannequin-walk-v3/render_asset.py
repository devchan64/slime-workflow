...
def emit_render_heartbeat():
 while True:
  print(f'{time.strftime("%Y-%m-%dT%H:%M:%S")}/asset-v3/heartbeat {CURRENT_PROGRESS_STATE}',flush=True);time.sleep(5)
...
print(f'{time.strftime("%Y-%m-%dT%H:%M:%S")}/asset-v3/complete',flush=True)
