# mannequin-walk v3 — ANNY 기준 모델

사용자 지정 기준 모델의 104본 리그와 4방향 × 8프레임(32프레임) OpenPose 제작 자산. 기존 v1·v2는 보존한다.
...
## 재현
이 폴더의 inputs/와 Python 스크립트를 새 .tmp/anny-pose-asset-v3/한국시간/ 경로에 복사한다. 보관 자산을 직접 덮어쓰지 않는다.
