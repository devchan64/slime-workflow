...
for current_direction_name,current_frame_points in current_keypoint_record['frames'].items():
 ...
 current_rig_sheet=Image.new('RGB',(2048,1024),'#dedede')
