...
class MoMaskGenerationManager:
 ...
 def handle(self,h):
  ...
  try:
   ...
   if h.command=='GET' and (match or frame_match or legacy_frame_match):
    if frame_match:
