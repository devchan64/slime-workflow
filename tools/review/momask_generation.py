...
ACTIONS={'standing':{'label':'대기','frames':16},'deep_breath':{'label':'심호흡','frames':40},'stretch':{'label':'스트레칭','frames':40},'walking':{'label':'걷기','frames':32}}
