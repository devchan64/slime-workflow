...
<script>
const fixed={walking:'A person walks forward at a relaxed pace.',standing:'A person stands.',deep_breath:"A person stands in place with both arms relaxed at the sides, slowly takes a deep breath, lifts the chest, and exhales back to a neutral standing posture.",stretch:'A person starts standing still with both arms hanging by the body and hands near the thighs, raises both arms above the head for a gentle stretch, then lowers both arms back beside the body and ends in the same standing pose.'};
