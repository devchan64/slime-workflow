...
def build_animation_tools(output):
    ...
    openpose_sources = (
        ...
        ('standing', '대기 스탠딩', ROOT / 'assets/motion-sheet/momask-standing-loops-v1' / 'standing' / 'openpose', {direction: list(range(1, 13)) for direction in DIRECTIONS}),
    ...
    for action, identifier, title, note in (
        ('standing', 'momask-normal-breath-standing', 'MoMask 대기 스탠딩', '12프레임 · 3초 · 4방향 · 미세 체중 이동'),
