...
def build_animation_tools(output):
    ...
    records.append({'id':'momask-generator','label':'MoMask 모션 생성기','path':'/momask-generator/','anchorEditor':False,'category':'animation-tool','description':'고정 포즈 스크립트 · 방향 선택 · 생성 로그·취소·결과 재생 · Anny 몸통 피치 보정 테스트'})
    rig=[]
    for direction in DIRECTIONS:
