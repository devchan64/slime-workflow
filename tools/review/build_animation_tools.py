...
def build_animation_tools(output):
    ...
    records.append({'id':'anny-attribute-renderer','label':'Anny 속성 렌더러','path':'anny-attribute-renderer/index.html','anchorEditor':False,'category':'animation-tool','description':'나이·체중·키와 몸통·어깨·다리 로컬 속성의 렌더 입력 검토'})
