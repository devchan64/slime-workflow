...
class AnnyProfileTests(unittest.TestCase):
    def test_neutral_is_the_active_default_profile(self):
        ...
        self.assertEqual(active_profile_record['profile_id'],'neutral_v1')
        self.assertEqual(active_profile_record['label'],'중성형 v1')
        self.assertEqual(active_profile_record['source_asset_id'],'anny-neutral-v1')
