...
def run_review_server(parsed_argument_values):
    ...
    from tools.review.common.gradio_process import ensure_character_animation_server, ensure_gradio_server, ensure_management_menu_server, ensure_qwen_2512_server
