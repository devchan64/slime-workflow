...
generationHistoryStyles.textContent+='#history-list{list-style:none;padding:0}#history-list>li{padding:12px 0;border-bottom:1px solid #42604c}#history-list>li.selected{background:#254532;border-radius:8px;padding:12px}#history-list .history-meta{font-size:12px;color:#b7cfbc;overflow-wrap:anywhere}#history-log{white-space:pre-wrap;max-height:220px;overflow:auto}';
