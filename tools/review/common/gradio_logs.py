...
def build_execution_logs():
    with gr.Accordion('실행 로그 · 펼쳐서 확인',open=False) as log_panel_element:
        ...
        log_output_element=create_copyable_log_textbox(label='작업을 선택하세요',lines=18,max_lines=30,interactive=False,autoscroll=True,elem_id='management-execution-log',elem_classes=['management-log-output'])
